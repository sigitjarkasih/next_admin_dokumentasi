...
import APIStaycationImageUpload from "../../../config/api/staycation/imageUpload";

class ImageArticleStaycationUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIStaycationImageUpload(formdata);
    console.log(resp);
...
export default ImageArticleStaycationUploadTools;
