...
import APIAkadTransaksiImageUpload from "../../../config/api/akadtransaksi/imageUpload";

class ImageArticleAkadtransaksiUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIAkadTransaksiImageUpload(formdata);
    console.log(resp);
...
export default ImageArticleAkadtransaksiUploadTools;
