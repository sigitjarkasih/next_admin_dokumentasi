...
import APIPembeliKomplainImageUpload from "../../../../config/api/dokumentasi_pembeli/komplainpesanan/imageUpload";

class ImageArticlePembeliKomplainUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIPembeliKomplainImageUpload(formdata);
    console.log(resp);
...
export default ImageArticlePembeliKomplainUploadTools;
