...
import APIPembeliAkunImageUpload from "../../../../config/api/dokumentasi_pembeli/akundankemanan/imageUpload";

class ImageArticlePembeliAkunUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIPembeliAkunImageUpload(formdata);
    console.log(resp);
...
export default ImageArticlePembeliAkunUploadTools;
