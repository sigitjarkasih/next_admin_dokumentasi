...
import APIPembeliPromosiImageUpload from "../../../../config/api/dokumentasi_pembeli/promosi/imageUpload";

class ImageArticlePembeliPromosiUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIPembeliPromosiImageUpload(formdata);
    console.log(resp);
...
export default ImageArticlePembeliPromosiUploadTools;
