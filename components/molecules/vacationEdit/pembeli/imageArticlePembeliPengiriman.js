...
import APIPembeliPengirimanImageUpload from "../../../../config/api/dokumentasi_pembeli/pengiriman/imageUpload";

class ImageArticlePembeliPengirimanUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIPembeliPengirimanImageUpload(formdata);
    console.log(resp);
...
export default ImageArticlePembeliPengirimanUploadTools;
