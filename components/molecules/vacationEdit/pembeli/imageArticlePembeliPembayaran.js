...
import APIPembeliPembayaranImageUpload from "../../../../config/api/dokumentasi_pembeli/pembayaran/imageUpload";

class ImageArticlePembeliPembayaranUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIPembeliPembayaranImageUpload(formdata);
    console.log(resp);
...
export default ImageArticlePembeliPembayaranUploadTools;
