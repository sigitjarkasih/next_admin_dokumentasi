...
import APIPembeliLainnyaImageUpload from "../../../../config/api/dokumentasi_pembeli/lainnya/imageUpload";

class ImageArticlePembeliLainnyaUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIPembeliLainnyaImageUpload(formdata);
    console.log(resp);
...
export default ImageArticlePembeliLainnyaUploadTools;
