...
import APIPenjualLainnyaImageUpload from "../../../../config/api/dokumentasi_penjual/lainnyapenjual/imageUpload";

class ImageArticlePenjualLainnyaUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIPenjualLainnyaImageUpload(formdata);
    console.log(resp);
...
export default ImageArticlePenjualLainnyaUploadTools;
