...
import APIPenjualAkunImageUpload from "../../../../config/api/dokumentasi_penjual/akundankeamanantoko/imageUpload";

class ImageArticlePenjualAkundanKeamananUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIPenjualAkunImageUpload(formdata);
    console.log(resp);
...
export default ImageArticlePenjualAkundanKeamananUploadTools;
