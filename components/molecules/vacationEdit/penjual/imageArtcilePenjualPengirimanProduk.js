...
import APIPenjualPengirimanImageUpload from "../../../../config/api/dokumentasi_penjual/pengirimanproduk/imageUpload";

class ImageArticlePenjualPengirimanProdukUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIPenjualPengirimanImageUpload(formdata);
    console.log(resp);
...
export default ImageArticlePenjualPengirimanProdukUploadTools;
