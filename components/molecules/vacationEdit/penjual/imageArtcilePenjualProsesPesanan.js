...
import APIPenjualProsesImageUpload from "../../../../config/api/dokumentasi_penjual/prosespesanan/imageUpload";

class ImageArticlePenjualProsesPesananUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIPenjualProsesImageUpload(formdata);
    console.log(resp);
...
export default ImageArticlePenjualProsesPesananUploadTools;
