...
import APIPenjualFiturImageUpload from "../../../../config/api/dokumentasi_penjual/fiturpenjual/imageUpload";

class ImageArticlePenjualFiturUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIPenjualFiturImageUpload(formdata);
    console.log(resp);
...
export default ImageArticlePenjualFiturUploadTools;
