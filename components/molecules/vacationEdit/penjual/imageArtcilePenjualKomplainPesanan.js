...
import APIPenjualKomplainImageUpload from "../../../../config/api/dokumentasi_penjual/komplainpesanantoko/imageUpload";

class ImageArticlePenjualKomplainUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIPenjualKomplainImageUpload(formdata);
    console.log(resp);
...
export default ImageArticlePenjualKomplainUploadTools;
