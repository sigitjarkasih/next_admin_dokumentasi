...
import APIRegisterImageUpload from "../../../config/api/register/imageUpload";

class ImageArticleRegisterUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIRegisterImageUpload(formdata);
    console.log(resp);
...
export default ImageArticleRegisterUploadTools;
