...
import APIPembeliImageUpload from "../../../config/api/pembeli/imageUpload";

class ImageArticlePembeliUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APIPembeliImageUpload(formdata);
    console.log(resp);
...
export default ImageArticlePembeliUploadTools;
