...
import APILoginImageUpload from "../../../config/api/login/imageUpload";

class ImageArticleLoginUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APILoginImageUpload(formdata);
    console.log(resp);
...
export default ImageArticleLoginUploadTools;
