...
import APISyariahAreaImageUpload from "../../../config/api/syariaharea/imageUpload";

class ImageArticleSyariahAreaUploadTools extends Component {
  constructor(props) {
    super(props);
  ...
  handleUpload = async (e) => {
    ...
    const resp = await APISyariahAreaImageUpload(formdata);
    console.log(resp);
...
export default ImageArticleSyariahAreaUploadTools;
