...
export default function MenuAkundanKeamananToko() {
  const [open, setOpen] = React.useState(false);
  const context = React.useContext(AppContext);
  const menu = "Penjual Akun dan Keamanan";
  ...
  return (
    <>
      <Link href="/menu_penjual_akundankeamanan">
        <ListMenu
          title="Penjual Akun dan Keamanan"
