...
import APIPenjualLainnyaListById from "../../config/api/dokumentasi_penjual/lainnyapenjual/listById";
import ImageArticlePenjualLainnyaUploadTools from "../../components/molecules/vacationEdit/penjual/imageArtcilePenjualLainnya";
import ConfirmationDialog from "../../components/molecules/vacationEdit/confirmationDialog";
import Router, { withRouter } from "next/router";
import Head from "next/head";
import APIPenjualLainnyaUpdate from "../../config/api/dokumentasi_penjual/lainnyapenjual/update";
import APIPenjualLainnyaDelete from "../../config/api/dokumentasi_penjual/lainnyapenjual/delete";
import Textarea from "../../components/molecules/vacationEdit/Textarea";

export async function getServerSideProps(context) {
  const res = await APIPenjualLainnyaListById({
    id: context.query.id,
  });
...
class PenjualLainnyaUpdate extends React.Component {
  state = {
  ...
  submitData = async (values) => {
    const resp = await APIPenjualLainnyaUpdate(values);
    if (resp.data === "success") {
      this.setState({
        open: true,
        message: "Update Berhasil",
      });
      Router.push("/menu_penjual_lainnya/");
    } else {
      this.setState({
        open: true,
  ...
  deleteArticle = async () => {
    ...
    const resp = await APIPenjualLainnyaDelete(data);
    Router.push("/menu_penjual_lainnya/");
  };
            ...
            <Form>
              ...
              <Widget.Paper>
                ...
                <Stack direction="row">
                  ...
                  <Button href="/menu_penjual_lainnya/">Daftar Artikel</Button>
                </Stack>
                <Widget.Box>
                  <Box mb={3}>
                    <Typography>Image</Typography>
                    <ImageArticlePenjualLainnyaUploadTools
                      id={this.state.id}
...
export default PenjualLainnyaUpdate;
