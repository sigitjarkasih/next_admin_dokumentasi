...
import APIPenjualProsesCreate from "../../config/api/dokumentasi_penjual/prosespesanan/create";

class PenjualProsesPesananAdd extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      master_judul: "",
  ...
  submitData = async (values) => {
    const resp = await APIPenjualProsesCreate(values);
    // console.log(resp);
...
export default PenjualProsesPesananAdd;
