...
import APIPenjualAkunListById from "../../config/api/dokumentasi_penjual/akundankeamanantoko/listById";
import ImageArticlePenjualAkundanKeamananUploadTools from "../../components/molecules/vacationEdit/penjual/imageArtcilePenjualAkundankeamanan";
import ConfirmationDialog from "../../components/molecules/vacationEdit/confirmationDialog";
import Router, { withRouter } from "next/router";
import Head from "next/head";
import APIPenjualAkunUpdate from "../../config/api/dokumentasi_penjual/akundankeamanantoko/update";
import APIPenjualAkunDelete from "../../config/api/dokumentasi_penjual/akundankeamanantoko/delete";
import Textarea from "../../components/molecules/vacationEdit/Textarea";

export async function getServerSideProps(context) {
  const res = await APIPenjualAkunListById({
    id: context.query.id,
  });
...
class PenjualAkundanKeamananUpdate extends React.Component {
  state = {
  ...
  submitData = async (values) => {
    const resp = await APIPenjualAkunUpdate(values);
    if (resp.data === "success") {
      this.setState({
        open: true,
        message: "Update Berhasil",
      });
      Router.push("/menu_penjual_akundankeamanan/");
    } else {
      this.setState({
        open: true,
  ...
  deleteArticle = async () => {
    ...
    const resp = await APIPenjualAkunDelete(data);
    Router.push("/menu_penjual_akundankeamanan/");
  };
            ...
            <Form>
              ...
              <Widget.Paper>
                ...
                <Stack direction="row">
                  ...
                  <Button href="/menu_penjual_akundankeamanan/">
                    Daftar Artikel
                  </Button>
                </Stack>
                <Widget.Box>
                  <Box mb={3}>
                    ...
                    <ImageArticlePenjualAkundanKeamananUploadTools
                      id={this.state.id}
...
export default PenjualAkundanKeamananUpdate;
