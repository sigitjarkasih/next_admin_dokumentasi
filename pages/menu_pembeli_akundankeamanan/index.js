...
import APIPembeliAkunList from "../../config/api/dokumentasi_pembeli/akundankemanan/list";
    ...
    return (
      <Layout>
        <Widget.Paper elevation={3}>
          ...
          <Widget.PageHeader title="Dokumentasi Article Akun dan Keamanan" />
          <Link href="./menu_pembeli_akundankeamanan/add">
                ...
                body={dataList.map(function (row) {
                  return [
                    ...
                    },
                    {
                      value: (
                        <Link
                          href={`./menu_pembeli_akundankeamanan/edit?id=${row.id}`}
                        >
