...
import APIDonasiListById from "../../config/api/donasi/listById";
import ImageArticleUploadTools from "../../components/molecules/vacationEdit/imageArticleUploadTools";
import ConfirmationDialog from "../../components/molecules/vacationEdit/confirmationDialog";
import Router, { withRouter } from "next/router";
import Head from "next/head";
import APIDonasiUpdate from "../../config/api/donasi/update";
import APIDonasiDelete from "../../config/api/donasi/delete";
...
export async function getServerSideProps(context) {
  const res = await APIDonasiListById({
    id: context.query.id,
  });
...
class DonasiUpdate extends React.Component {
  ...
  submitData = async (values) => {
    const resp = await APIDonasiUpdate(values);
  ...
  deleteArticle = async () => {
    ...
    const resp = await APIDonasiDelete(data);
    if (resp.data === "success") {
