...
import APIEventListById from "../../config/api/event/listById";
import ImageArticleEventUploadTools from "../../components/molecules/vacationEdit/imageArticleEventUploadTools";
import ConfirmationDialog from "../../components/molecules/vacationEdit/confirmationDialog";
import Router, { withRouter } from "next/router";
import APIEventUpdate from "../../config/api/event/update";
import APIEventDelete from "../../config/api/event/delete";
...
export async function getServerSideProps(context) {
  const res = await APIEventListById({
    id: context.query.id,
  });
...
class DonasiUpdate extends React.Component {
  ...
  submitData = async (values) => {
    const resp = await APIEventUpdate(values);
  ...
  deleteArticle = async () => {
    ...
    const resp = await APIEventDelete(data);
    if (resp.data === "success") {
