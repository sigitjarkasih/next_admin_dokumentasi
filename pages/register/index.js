...
// import APIArticleList from "../../config/api/article/list";
import APIRegisterList from "../../config/api/register/list";
...
class ArticlePage extends React.Component {
  ...
  getData = async () => {
    const resp = await APIRegisterList({
    ...
    return (
      <Layout>
        <Widget.Paper elevation={3}>
          ...
          <Widget.PageHeader title="Dokumentasi Article Registrasi" />
          <Link href="./register/add">
              ...
              <Widget.Table
                ...
                body={dataList.map(function (row) {
                  return [
                    ...
                    {
                      value: (
                        <Link href={`./register/edit?id=${row.id}`}>
