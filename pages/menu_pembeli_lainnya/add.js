...
import APIPembeliLainnyaCreate from "../../config/api/dokumentasi_pembeli/lainnya/create";

class PembeliLainnyaAdd extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      master_judul: "",
...
export default PembeliLainnyaAdd;
