...
import APIPenjualPengirimanCreate from "../../config/api/dokumentasi_penjual/pengirimanproduk/create";

class PenjualPengirimanProdukAdd extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      master_judul: "",
  ...
  submitData = async (values) => {
    const resp = await APIPenjualPengirimanCreate(values);
    // console.log(resp);
      ...
      <Layout>
        ...
        >
          {(formik) => (
            <Form>
              <Widget.Paper>
                <Widget.PageHeader title="Dokumentasi Article Pengiriman Produk" />
                <Widget.Box>
                  <FrameField
                    title="Master Judul"
                    child={
...
export default PenjualPengirimanProdukAdd;
